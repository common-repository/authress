...
return array(
    'Authress_Sso_Login_Admin' => $baseDir . '/lib/Authress_Sso_Login_Admin.php',
    'Authress_Sso_Login_Admin_Generic' => $baseDir . '/lib/Authress_Sso_Login_Admin_Generic.php',
    'Authress_Sso_Login_BeforeLoginException' => $baseDir . '/lib/Authress_Sso_Login_BeforeLoginException.php',
    'Authress_Sso_Login_CouldNotCreateUserException' => $baseDir . '/lib/Authress_Sso_Login_CouldNotCreateUserException.php',
    'Authress_Sso_Login_ErrorLog' => $baseDir . '/lib/Authress_Sso_Login_ErrorLog.php',
    'Authress_Sso_Login_InitialSetup' => $baseDir . '/lib/Authress_Sso_Login_InitialSetup.php',
    'Authress_Sso_Login_InvalidIdTokenException' => $baseDir . '/lib/Authress_Sso_Login_InvalidIdTokenException.php',
    'Authress_Sso_Login_Lock' => $baseDir . '/lib/Authress_Sso_Login_Lock.php',
    'Authress_Sso_Login_LoginFlowValidationException' => $baseDir . '/lib/Authress_Sso_Login_LoginFlowValidationException.php',
    'Authress_Sso_Login_LoginManager' => $baseDir . '/lib/Authress_Sso_Login_LoginManager.php',
    'Authress_Sso_Login_Options' => $baseDir . '/lib/Authress_Sso_Login_Options.php',
    'Authress_Sso_Login_Profile_Delete_Data' => $baseDir . '/lib/Authress_Sso_Login_Profile_Delete_Data.php',
    'Authress_Sso_Login_Routes' => $baseDir . '/lib/Authress_Sso_Login_Routes.php',
    'Authress_Sso_Login_Serializer' => $baseDir . '/lib/Authress_Sso_Login_Serializer.php',
    'Authress_Sso_Login_Settings_Configuration' => $baseDir . '/lib/Authress_Sso_Login_Settings_Configuration.php',
    'Authress_Sso_Login_Users' => $baseDir . '/lib/Authress_Sso_Login_Users.php',
    'Authress_Sso_Login_UsersRepo' => $baseDir . '/lib/Authress_Sso_Login_UsersRepo.php',
    'CoderCat\\JWKToPEM\\Exception\\Base64DecodeException' => $vendorDir . '/codercat/jwk-to-pem/src/Exception/Base64DecodeException.php',
    'CoderCat\\JWKToPEM\\Exception\\JWKConverterException' => $vendorDir . '/codercat/jwk-to-pem/src/Exception/JWKConverterException.php',
    'CoderCat\\JWKToPEM\\JWKConverter' => $vendorDir . '/codercat/jwk-to-pem/src/JWKConverter.php',
    'CoderCat\\JWKToPEM\\Util\\Base64UrlDecoder' => $vendorDir . '/codercat/jwk-to-pem/src/Util/Base64UrlDecoder.php',
